...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../team-player.test-samples';

import { TeamPlayerService } from './team-player.service';

const requireRestSample: ITeamPlayer = {
...
describe('TeamPlayer Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a TeamPlayer', () => {
      ...
      const teamPlayer = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(teamPlayer).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a TeamPlayer', () => {
      const teamPlayer = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(teamPlayer).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addTeamPlayerToCollectionIfMissing', () => {
      it('should add a TeamPlayer to an empty array', () => {
        const teamPlayer: ITeamPlayer = sampleWithRequiredData;
      ...
      it("should add a TeamPlayer to an array that doesn't contain it", () => {
        const teamPlayer: ITeamPlayer = sampleWithRequiredData;
        const teamPlayerCollection: ITeamPlayer[] = [sampleWithPartialData];
        expectedResult = service.addTeamPlayerToCollectionIfMissing(teamPlayerCollection, teamPlayer);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(teamPlayer);
      });
      ...
      it('should add only unique TeamPlayer to an array', () => {
        const teamPlayerArray: ITeamPlayer[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const teamPlayerCollection: ITeamPlayer[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const teamPlayer: ITeamPlayer = sampleWithRequiredData;
        const teamPlayer2: ITeamPlayer = sampleWithPartialData;
    ...
    describe('compareTeamPlayer', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTeamPlayer(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTeamPlayer(entity1, entity2);
        const compareResult2 = service.compareTeamPlayer(entity2, entity1);
