...
type GameFormGroupContent = {
  ...
  order: FormControl<IGame['order']>;
  scoreOne: FormControl<IGame['scoreOne']>;
  scoreTwo: FormControl<IGame['scoreTwo']>;
  overwatchMap: FormControl<IGame['overwatchMap']>;
  match: FormControl<IGame['match']>;
};
...
export class GameFormService {
  createGameFormGroup(game: GameFormGroupInput = { id: null }): GameFormGroup {
    ...
    return new FormGroup<GameFormGroupContent>({
      ...
      order: new FormControl(gameRawValue.order, {
        validators: [Validators.required, Validators.min(0)],
      }),
      scoreOne: new FormControl(gameRawValue.scoreOne, {
        validators: [Validators.required],
      }),
      scoreTwo: new FormControl(gameRawValue.scoreTwo, {
        validators: [Validators.required],
      }),
      overwatchMap: new FormControl(gameRawValue.overwatchMap),
      match: new FormControl(gameRawValue.match),
    });
  }
