...
export class TeamService {
  ...
  findTeamByNameLike(name: String) {
    return this.http.get<ITeam[]>(`${this.resourceUrl}/search-like/${name}`, { observe: 'response' });
  }
  ...
  join(teamId: number): Observable<HttpResponse<{}>> {
    return this.http.put(`${this.resourceUrl}/join/${teamId}`, { observe: 'response' }) as Observable<HttpResponse<{}>>;
  }

  leave(teamId: number): Observable<HttpResponse<{}>> {
    return this.http.delete(`${this.resourceUrl}/leave/${teamId}`, { observe: 'response' });
  }

  findAllByPlayerId(playerId: number): Observable<EntityArrayResponseType> {
    return this.http.get<ITeam[]>(`${this.resourceUrl}/search/${playerId}`, { observe: 'response' });
  }
  findTopteams(): Observable<EntityArrayResponseType> {
    return this.http.get<ITeam[]>(`${this.resourceUrl}/top`, { observe: 'response' });
  }
  ...
  getTeamDataByPlayerId(playerId: number): Observable<EntityArrayResponseType> {
    return this.http.get<ITeam[]>(`${this.resourceUrl}/player/${playerId}`, { observe: 'response' });
  }
