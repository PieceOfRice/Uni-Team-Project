...
type TeamFormGroupContent = {
  ...
  banner: FormControl<ITeam['banner']>;
  bannerContentType: FormControl<ITeam['bannerContentType']>;
...
export class TeamFormService {
  createTeamFormGroup(team: TeamFormGroupInput = { id: null }): TeamFormGroup {
    ...
    return new FormGroup<TeamFormGroupContent>({
      ...
      banner: new FormControl(teamRawValue.banner),
      bannerContentType: new FormControl(teamRawValue.bannerContentType),
