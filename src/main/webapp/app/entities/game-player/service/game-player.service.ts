...
export class GamePlayerService {
  ...
  getGamePlayersByGameId(id: number): Observable<EntityArrayResponseType> {
    return this.http.get<IGamePlayer[]>(`${this.resourceUrl}/game/${id}`, { observe: 'response' });
  }
  ...
  deleteByGameId(id: number): Observable<HttpResponse<{}>> {
    return this.http.delete(`${this.resourceUrl}/game/${id}`, { observe: 'response' });
  }
