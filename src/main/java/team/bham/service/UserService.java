...
public class UserService {
    ...
    public User registerUser(AdminUserDTO userDTO, String password) {
        ...
        playerDataService.createDefault(newUser);
    ...
    public User createUser(AdminUserDTO userDTO) {
        ...
        playerDataService.createDefault(user);
    ...
    public void deleteUser(User user) {
        ...
        playerDataRepository.findOneByUser(user).ifPresent(playerDataRepository::delete);
    ...
    public void deleteUserByLogin(String login) {
        userRepository.findOneByLogin(login).ifPresent(this::deleteUser);
    }
