...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/team-players/**").permitAll()
            .antMatchers("/api/participants/tournament/**").permitAll()
            .antMatchers("/api/player-data/**").permitAll()
            .antMatchers("/api/tournaments/**").permitAll()
            .antMatchers("/api/game-players/**").permitAll()
            .antMatchers("/api/games/**").permitAll()
            .antMatchers("/api/overwatch-maps/**").permitAll()
